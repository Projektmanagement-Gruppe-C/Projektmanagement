...
public class InnentuerenView extends BasisView{
    ...
    private final Label lblKlarglas
        = new Label("Mehrpreis f�r die Ausf�hrung eines Glasausschnitts"
        		+ "(Klarglas) in einer Innent�r:");
    ...
    private final Label lblMilchglas = new Label("Mehrpreis f�r die Ausf�hrung eines Glasausschnitts"
    		+ "(Milchglas) in einer Innent�r:");
    ...
    public InnentuerenView (InnentuerenControl innentuerenControl, Stage innentuerenStage){
        ...
        innentuerenStage.setTitle("Sonderwünsche zu den Innentueren");
	...
	protected void schreibeInCSV() {
		//TODO
		System.out.println("CSV Export_Innent�ren");
	}
