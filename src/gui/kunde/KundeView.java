...
public class KundeView {
    ...
    private final Button btnAendern = new Button("Ã„ndern");
    private final Button btnLoeschen = new Button("LÃ¶schen");
    private final MenuBar mnBar = new MenuBar();
    private final Menu mnSonderwuensche = new Menu("SonderwÃ¼nsche");
    ...
    private MenuItem mnItmFensterTuere = new MenuItem("Fenster und Außentüren");
    ...
    private void initKomponenten() {
        ...
        mnSonderwuensche.getItems().add(mnItmFensterTuere);
    }
    ...
    private void initListener() {
        ...
        mnItmFensterTuere.setOnAction(aEvent -> kundeControl.oeffneFensterTuereView());
    }
